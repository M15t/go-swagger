...
func TestDefaultImports(t *testing.T) {
	for i, toPin := range []struct {
	...
	}{
		{
			...
			Opts:  &GenOpts{},
			Expected: map[string]string{
				"models": "github.com/M15t/go-swagger/generator/models",
			},
		},
		{
			...
			Expected: map[string]string{
				"ext":    "github.com/M15t/go-swagger/generator/ext",
				"models": "github.com/M15t/go-swagger/generator/models",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/M15t/go-swagger/generator/target/bespoke",
			},
		},
		{
		...
		// issue #2362
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/M15t/go-swagger/generator/target/bespoke",
				"auth":    "github.com/M15t/go-swagger/generator/auth",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"models": "github.com/M15t/go-swagger/generator/target/models",
				"auth":   "target/auth",
			},
		},
	} {
