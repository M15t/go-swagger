...
import (
	...
	"github.com/M15t/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/M15t/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
