...
import (
	...
	"github.com/M15t/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/M15t/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
